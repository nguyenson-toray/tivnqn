...
//         currentTime = DateTime.now();
//         if (currentTime
//                 .add(Duration(milliseconds: g.ntpTimeOffsetMilliseconds))
//                 .isAfter(exceriseBegin) &&
//             !isPlaying &&
//             playerIsReady) {
//           controller.play();
//           setState(() {
//             isPlaying = true;
//             debugText += " - Actual play at: ${DateTime.now()}";
//           });
//         }
//       });
...
//       //     // controller.play();
//       //     controller.seekTo(Duration(milliseconds: 400));
//       //     setState(() {
//       //       currentTime = DateTime.now();
//       //       isPlaying = true;
//       //       currentTime = DateTime.now();
...
//               )),
//           Positioned(bottom: 30, left: 10, child: MyFuntions.getClock(context)),
//         ],
//       ),
//     );
//   }
